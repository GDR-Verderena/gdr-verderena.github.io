...
$(function(){
    $(".post").slice(0, 2).show(); // select the first ten
    $("#load").click(function(e){ // click event for load more
        e.preventDefault();
        $(".post:hidden").slice(0, 2).show(); // select next 10 hidden divs and show them
        if($(".post:hidden").length == 0){ // check if any hidden divs still exist
           $("#load").hide()
